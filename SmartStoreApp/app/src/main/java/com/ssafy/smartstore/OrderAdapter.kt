...
class OrderAdapter(val context: Context, var list: MutableList<Product>, var userID: String): RecyclerView.Adapter<GridAdapter>() {

    private lateinit var storeRepository: StoreRepository

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GridAdapter {
        var view = LayoutInflater.from(parent.context).inflate(R.layout.items_product, parent, false)
...
class GridAdapter(itemView: View)
